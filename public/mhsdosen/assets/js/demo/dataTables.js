 ...
 *
 */
//window.location.protocol + "//" + window.location.host + "/skripsi-dev/public/mhsdosen/plugins/datatables/TableTools/swf/copy_csv_xls_pdf.swf";
;
(function( $, window, document, undefined ) {

    var baseurl = window.location.protocol + "/mhsdosen/plugins/datatables/TableTools/swf/copy_csv_xls_pdf.swf";
    var demos = {
